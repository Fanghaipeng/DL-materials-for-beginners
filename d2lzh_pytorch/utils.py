...
def evaluate_accuracy(data_iter, net, device=None):
    """
    # 计算测试准确率 一般为计算测试集的准确率.
    参照 https://zh.d2l.ai  https://tangshusen.me/Dive-into-DL-PyTorch 修改实现
    Args:
        data_iter: 需要计算的数据集 Class:DataLoader  Shape of X,y: [batch_size, number of channels, H, W].
        net:  . 
        device:  . 
    Returns:
        The accuracy. type:float
    """
...
def train_ch5(net, train_iter, test_iter, batch_size, optimizer, device, num_epochs):
    ...
    参照 https://zh.d2l.ai  https://tangshusen.me/Dive-into-DL-PyTorch 修改实现
    Args:
        train_iter: 训练集合 Class:DataLoader  Shape of X,y: [batch_size, number of channels, H, W].
        test_iter: 测试集合 Class:DataLoader  Shape of X,y: [batch_size, number of channels, H, W]
        batch_size: 批量.
        optimizer: 优化器.
        num_epoch: 轮次. 
    Returns:
